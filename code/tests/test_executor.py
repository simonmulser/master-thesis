...
class ExecutorTest(unittest.TestCase):
    ...
    def test_match_lead_public(self):
        private_tip = Block(None, None)
        private_tip.height = 1

        public_tip = Block(None, None)
        public_tip.height = 2
    ...
    def test_override_two_blocks_lead_private(self):
        third_block_chain_a = Block(None, BlockOrigin.private)
    ...
    def test_adopt_two_blocks_lead_public(self):
        third_block_chain_b = Block(None, BlockOrigin.public)
