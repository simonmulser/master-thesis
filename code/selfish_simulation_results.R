...
xyplot(selfish_mined_share ~ selfish_share, df, type = 'l', groups = factor(strategy), asp = 1,
       ...
       auto.key = list(columns=2, lines = TRUE, points = FALSE, space='top', text=levels(df$strategy))
)

df$stale_block_share = df$stale_blocks_selfish_miner/(df$stale_blocks_selfish_miner + df$stale_blocks_honest)
xyplot(stale_block_share ~ selfish_share, df, type = 'l', groups = factor(strategy), asp = 1,
...
xyplot(stale_rate ~ selfish_share, df, type = 'l', groups = factor(strategy), asp = 1,
...
xyplot(accepted_blocks_selfish_miner ~ selfish_share, df, type = 'l', groups = factor(strategy), asp = 1,
...
xyplot(accepted_blocks_honest ~ selfish_share, df, type = 'l', groups = factor(strategy), asp = 1,
