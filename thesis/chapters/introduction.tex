...
In the optimal case where all nodes behave honestly and      all miner have the same connection to the network the relative gain of a miner is equal to its computational share.
\todo[inline]{The term "relative gain" needs to to be explained before usage. Why is the gain only relative? Because overall hash rate drops ... Why is this still in favour of the attacker ...make it easier here... move expl of relative gain into state-of-the-art }
