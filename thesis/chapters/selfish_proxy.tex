...
\todo[inline]{Is it possible to have multiple eclipsed nodes? I guess not - but then the selfish mining proxy can directly be used as an attack tool by a MiTM attacker. Maybe this should be mentioned}
...
\todo[inline]{Some comment as in Introduction, explain relative gain}
...
\todo[inline]{I would generally suggest to switch the section "Selfish Mining" into the Introduction.}
