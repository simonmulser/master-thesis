...
\aju{Double check the percent able value, but generally its better to have some facts here and state that there really are that little big pools.}
...
\aju{Maybe add at the beginning: ''In accordance with previous results, the most efficient ...''}
