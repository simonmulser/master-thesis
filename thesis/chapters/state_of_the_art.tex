...
\todo[inline]{The term "relative gain" needs to to be explained before usage. Why is the gain only relative? Because overall hash rate drops ... Why is this still in favour of the attacker ... }
...
\todo[inline]{Either add more details to the counter measures and how they work, or explicitly say that they are not in the focus of this paper. 
This might also provide glue to the next chapter e.g., provide a possibility to evaluate counter measures, therefore simulation ... }
