...
Uniform tie breaking is currently not implemented in Bitcoin \cite{}Another countermeasure foresees unforgeable timestamps to secure Bitcoin against selfish mining \cite{billah2015one}.
